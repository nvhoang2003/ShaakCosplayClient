        ...
        <Box display={{ base: 'none', md: 'flex' }} alignItems='center' px={2} >
          ...
          >
            ...
            }
            {
              ...
              //  </>
            <Box p={4} >
                <Button pl = {3} pr ={15} py = {4} borderTopRightRadius={0} borderBottomRightRadius={0} colorScheme="teal" variant='outline'>Đăng Nhập</Button>
                <Button pl = {3} pr ={15} py = {4} borderTopLeftRadius={0} borderBottomLeftRadius={0} colorScheme="teal" variant='outline'>Đăng Ký</Button>
            </Box>
            }
            {
              admin && currentUser &&
